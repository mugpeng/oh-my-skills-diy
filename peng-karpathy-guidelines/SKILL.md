---
name: peng-karpathy-guidelines
description: Behavioral guidelines to reduce common LLM coding mistakes and keep implementation work simple, clear, decoupled, honest, and durable. Use when writing, reviewing, or refactoring code to avoid overcomplication, make surgical changes, surface assumptions, define verifiable success criteria, preserve clean boundaries, and choose maintainable/testable solutions.
---

# Peng Karpathy Guidelines
